# Bonsai demo reference

This is the detailed setup and model guide for the Bonsai demo that this project builds on. For the student project's current status, start with [README.md](README.md).
